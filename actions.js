...
const color = document.querySelector(".color");  // Return first selector
...
//   const randomNumber = getRandomNumber();
//   document.body.style.backgroundColor = colors[randomNumber];  // To chane bg Color
//   color.textContent = colors[randomNumber]; // To change code of Color
